...
class Player(models.Model):
    ...
    fixture = models.ForeignKey(Fixture, related_name="players",on_delete=models.PROTECT,default=1)
...
class Match(models.Model):
    ...
    fixture = models.ForeignKey(Fixture, related_name="matches",on_delete=models.PROTECT,default=1)
    match_round = models.IntegerField()
    left_previous = models.OneToOneField(
        'self', blank=True, null=True, related_name="left_next_match",on_delete=models.PROTECT)
    right_previous = models.OneToOneField(
        'self', blank=True, null=True, related_name="right_next_match",on_delete=models.PROTECT)

    player_1 = models.ForeignKey(
        Player, blank=True, null=True, related_name="left_matches",on_delete=models.PROTECT,default=1)
    player_2 = models.ForeignKey(
        Player, blank=True, null=True, related_name="right_matches",on_delete=models.PROTECT,default=1)
    ...
    winner = models.ForeignKey(
        Player, blank=True, null=True, related_name="matches_won",on_delete=models.PROTECT,default=1)
